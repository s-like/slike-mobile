            ...
            child: Row(
              ...
              children: [
                ...
                ToolButton(
                  ...
                  padding: const EdgeInsets.symmetric(horizontal: 5),
                  backGroundColor: paintingNotifier.paintingType == PaintingType.pen ? Colors.white.withValues(alpha:0.9) : Colors.black12,
                  child: Transform.scale(
                      scale: 1.2,
                      child: ImageIcon(
                ...
                ToolButton(
                  ...
                  padding: const EdgeInsets.symmetric(horizontal: 5),
                  backGroundColor: paintingNotifier.paintingType == PaintingType.marker ? Colors.white.withValues(alpha:0.9) : Colors.black12,
                  child: Transform.scale(
                      scale: 1.2,
                      child: ImageIcon(
                ...
                ToolButton(
                  ...
                  padding: const EdgeInsets.symmetric(horizontal: 5),
                  backGroundColor: paintingNotifier.paintingType == PaintingType.neon ? Colors.white.withValues(alpha:0.9) : Colors.black12,
                  child: Transform.scale(
                      scale: 1.1,
                      child: ImageIcon(

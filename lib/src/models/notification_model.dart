  ...
  Notification.fromJSON(Map<String, dynamic> json) {
    try {
      ...
      sentOn = json["sent_on"] == null
          ? ''
          : formatterDate.format(CommonHelper.getYourCountryTime(DateFormat("yyyy-MM-dd HH:mm:ss").parse(json["sent_on"]))) +
              " " +
              formatterTime.format(CommonHelper.getYourCountryTime(DateFormat("yyyy-MM-dd HH:mm:ss").parse(json["sent_on"])));

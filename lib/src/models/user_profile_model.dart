...
class UserProfileModel {
  ...
  UserProfileModel.fromJSON(Map<String, dynamic> jsonMap) {
    print("UserProfileModel.fromJSON jsonMap['data'] ${jsonMap['data']}");
    try {
      totalRecords = jsonMap['totalRecords'] != null ? jsonMap['totalRecords'] : 0;
      totalVideosLike = jsonMap['totalVideosLike'] != null ? jsonMap['totalVideosLike'] : '0';
